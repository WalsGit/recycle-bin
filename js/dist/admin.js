...
var RecycleBinPage = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    m.request({
      ...
      _this2.hiddenDiscussionsCount(typedResult.hidden_discussions_count); // Met à jour le stream
...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('walsgit/recycle-bin', function () {
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('walsgit-recycle-bin').registerPage(_components_RecycleBinPage__WEBPACK_IMPORTED_MODULE_1__["default"]);
});
